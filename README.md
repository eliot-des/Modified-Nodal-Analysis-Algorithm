...
---
This repository is just the implementation of the Modified Nodal Analysis for **transient analysis** of electronic circuit. This is a work in progress and this deposit serves as a test environnement to make a [real-time audio plugin](https://github.com/eliot-des/MNAlgorithm-Audio-Plugin).
